@REM play-getting-started launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PLAY_GETTING_STARTED_config.txt found in the PLAY_GETTING_STARTED_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%PLAY_GETTING_STARTED_HOME%"=="" set "PLAY_GETTING_STARTED_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%PLAY_GETTING_STARTED_HOME%\lib\"
...
set "CFG_FILE=%PLAY_GETTING_STARTED_HOME%\PLAY_GETTING_STARTED_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running play-getting-started.
  echo.
